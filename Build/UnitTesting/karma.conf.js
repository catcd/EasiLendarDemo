...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: '../EasiLendar/www/js/controllers/MyProfileController.js', watched: true, included: true, served: true},
      ...
      {pattern: 'jasmine/js/controllers/MyProfileControllerTest.js', watched: true, included: true, served: true},
